class Tilefeed < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/muimsd/tilefeed/releases/download/v0.7.0/tilefeed-aarch64-apple-darwin.tar.gz"
      sha256 "6b3c185ce3d55d2917d2ffc7451b4e2ea701766cbdb7c41400b4a45757be5885"
    end
    on_intel do
      url "https://github.com/muimsd/tilefeed/releases/download/v0.7.0/tilefeed-x86_64-apple-darwin.tar.gz"
      sha256 "9ecb670d3f18b70424c68022e48a7c29168d22ffd66d2df4fd797212ebb4e3bc"
    end
  end

  on_linux do
    url "https://github.com/muimsd/tilefeed/releases/download/v0.7.0/tilefeed-x86_64-unknown-linux-gnu.tar.gz"
